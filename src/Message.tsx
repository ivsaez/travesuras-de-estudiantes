      ...
      <div className="row no-gutters">
        ...
        <div className="col">
          <div className="card-block px-2">
            <Card.Title className="card-title mt-1">
              {props.agentMessage.agent}
            </Card.Title>
            <Card.Text className="card-text">
              {props.agentMessage.message}
            </Card.Text>
          </div>
        </div>
...
function imageComponent(image: string) {
  return (
    <div className="col-auto">
      <img src={image} className="img-fluid" alt="face" width={150} />
    </div>
  );
}
