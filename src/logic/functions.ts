...
export class Functions{
    private static _funcs: Function[] = [
        ...
        new Function("LlamadaPolicia", Cardinality.None),
        new Function("Muerto", Cardinality.None),
        new Function("Enrollados", Cardinality.None),
        ...
        new Function("Policia", Cardinality.One),
        new Function("Rendido", Cardinality.One),
        new Function("Desafio", Cardinality.One),
