...
export class EndingAgentRepository{
    private _elements: Agent[];
    ...
    constructor(){
        ...
        this._elements.push(new Agent(
            "Recepcionista",
            new Aspect(SexKind.Male, OriginKind.European, EyeColor.Blue, HairColor.Black, HaircutStyle.Bald, ComplexionKind.Thin, 175, 50),
            new RelationSet(),
            new Happiness(0),
        ...
        this._elements.push(new Agent(
            "Mariano",
            new Aspect(SexKind.Male, OriginKind.European, EyeColor.Brown, HairColor.White, HaircutStyle.Short, ComplexionKind.Skinny, 180, 86),
            new RelationSet(),
            new Happiness(),
            new Personality(50, 50, 50, 50, 50),
            Likes.likesSpecieAndSex(SpecieKind.Human, SexKind.Female),
