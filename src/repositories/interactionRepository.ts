...
export class EndingInteractionRepository{
    private _elements: IInteraction[];
    ...
    constructor(){
        ...
        this._elements.push(new Interaction(
            "Ending",
            "Ending",
            new RolesDescriptor("Nobody"),
            [
                new Phrase("Nobody")
                    .withAlternative(roles => "--LA RESIDENCIA (2036)--")
            ],
            Timing.GlobalSingle,
            (postconditions, roles, map) => 
                postconditions.exists(Sentence.build("Bueno", "Anselmo"))
                || postconditions.exists(Sentence.build("Bueno", "Fructuoso")),
            (roles, map) => new TruthTable()
                .with(Sentence.build("EndingTitle"))
        ));

        this._elements.push(new Interaction(
            "LlegaHombreARecepcion",
            "Un anciano se acerca a la recepción",
            new RolesDescriptor("Anciano", [ "Recepcionista" ]),
            [
                new Phrase("Anciano")
                    .withAlternative(roles => "Un anciano se aproxima al mostrador de la recepción."),
                new Phrase("Recepcionista")
                    .withAlternative(roles => "[Recepcionista]: ¿En qué puedo ayudarle caballero? ¿Viene usted a ingresar en la residencia? Dígame su nombre y..."),
                new Phrase("Anciano")
                    .withAlternative(roles => "[Anciano]: Me llamo Mariano Caspe... pero no vengo a ingresar. Verá joven, vengo buscando a un señor que ha estado ingrsado aquí."),
                new Phrase("Recepcionista")
                    .withAlternative(roles => "[Recepcionista]: ¿Es un amigo suyo señor Caspe? Dígame el nombre y busco a ver donde se encuentra.")
            ],
            Timing.GlobalSingle,
            (postconditions, roles, map) => 
                map.getUbication(roles.get("Anciano")).name === "Recepcion" 
                && map.areInTheSameLocation(roles.get("Anciano"), roles.get("Recepcionista"))
                && roles.get("Anciano").IsActive
                && roles.get("Recepcionista").IsActive
                && postconditions.exists(Sentence.build("EndingTitle")),
            (roles, map) => new TruthTable()
                .with(Sentence.build("Recepcion"))
        ));

        this._elements.push(new Interaction(
            "ConversacionAnselmo",
            "El anciano pregunta por Anselmo",
            new RolesDescriptor("Anciano", [ "Recepcionista" ]),
            [
                new Phrase("Anciano")
                    .withAlternative(roles => "[Anciano]: Busco a Anselmo Rubiales. Ése es el nombre, Anselmo Rubiales."),
                new Phrase("Recepcionista")
                    .withAlternative(roles => "[Recepcionista]: Déjeme ver... en efecto, tenemos un Anselmo Rubiales. Uy..."),
                new Phrase("Anciano")
                    .withAlternative(roles => "[Anciano]: ¿Es aquí entonces?"),
                new Phrase("Recepcionista")
                    .withAlternative(roles => "[Recepcionista]: Disculpe señor Caspe, pero me figura que ese hombre falleció hace 20 años."),
                new Phrase("Anciano")
                    .withAlternative(roles => "[Anciano]: ¡Pues claro! ¡No iba a estar vivo todavía! ¿Podría indicarme si es usted tan amble dónde lo enterraron?"),
                new Phrase("Recepcionista")
                    .withAlternative(roles => "[Recepcionista]: Supongo que no hay problema... Fue en su pueblo natal, cerca de Toledo. Ésta es la dirección."),
                new Phrase("Anciano")
                    .withAlternative(roles => "[Anciano]: Parece que por fin lo encuentro. No ha habido manera, ni con esquelas, ni registros... nada."),
                new Phrase("Recepcionista")
                    .withAlternative(roles => "[Recepcionista]: ¿Puedo saber de qué lo conocía? Hay una buena diferencia de edad."),
                new Phrase("Anciano")
                    .withAlternative(roles => "[Anciano]: Pues no lo conocía de nada."),
                new Phrase("Recepcionista")
                    .withAlternative(roles => "[Recepcionista]: ¿Perdón?"),
                new Phrase("Anciano")
                    .withAlternative(roles => "[Anciano]: Mi padre en su testamento insistió behementemente que necesitaba llevar flores a la tumba de este hombre."),
                new Phrase("Anciano")
                    .withAlternative(roles => "[Anciano]: Quiso verle él mismo pero nunca llegó a encontrarle. Yo llevo años buscándolo sabiendo solo bagamente su nombre y lo que mi padre encontró."),
                new Phrase("Anciano")
                    .withAlternative(roles => "[Anciano]: Ya pensaba que mi hijo heredaría la tarea. Mire usted qué suerte. A Toledo pues iremos."),
                new Phrase("Recepcionista")
                    .withAlternative(roles => "[Recepcionista]: Que historia tan curiosa. Esconde la gente anciana a menudo historias fascinantes."),
                new Phrase("Anciano")
                    .withAlternative(roles => "[Anciano]: Desde luego."),
                new Phrase("Recepcionista")
                    .withAlternative(roles => "[Recepcionista]: Mucha suerte en Toledo señor Caspe. Por cierto, le dejo un tríptico de la residencia por si cambia de idea..."),
            ],
            Timing.GlobalSingle,
            (postconditions, roles, map) => 
                map.getUbication(roles.get("Anciano")).name === "Recepcion" 
                ...
                && roles.get("Recepcionista").IsActive
                && postconditions.exists(Sentence.build("EndingTitle"))
                && postconditions.exists(Sentence.build("Recepcion"))
                && postconditions.exists(Sentence.build("Bueno", "Anselmo")),
            (roles, map) => TruthTable.empty
        ));

        this._elements.push(new Interaction(
            "ConversacionFructuoso",
            "El anciano pregunta por Fructuoso",
            new RolesDescriptor("Anciano", [ "Recepcionista" ]),
            [
                new Phrase("Anciano")
                    .withAlternative(roles => "[Anciano]: Busco a Fructuoso Padilla. Ése es el nombre, Fructuoso Padilla."),
                new Phrase("Recepcionista")
                    .withAlternative(roles => "[Recepcionista]: Déjeme ver... en efecto, tenemos un Fructuoso Padilla. Uy..."),
                new Phrase("Anciano")
                    .withAlternative(roles => "[Anciano]: ¿Es aquí entonces?"),
                new Phrase("Recepcionista")
                    .withAlternative(roles => "[Recepcionista]: Disculpe señor Caspe, pero me figura que ese hombre falleció hace 20 años."),
                new Phrase("Anciano")
                    .withAlternative(roles => "[Anciano]: ¡Pues claro! ¡No iba a estar vivo todavía! ¿Podría indicarme si es usted tan amble dónde lo enterraron?"),
                new Phrase("Recepcionista")
                    .withAlternative(roles => "[Recepcionista]: Supongo que no hay problema... Fue en su pueblo natal, cerca de Burgos. Ésta es la dirección."),
                new Phrase("Anciano")
                    .withAlternative(roles => "[Anciano]: Parece que por fin lo encuentro. No ha habido manera, ni con esquelas, ni registros... nada."),
                new Phrase("Recepcionista")
                    .withAlternative(roles => "[Recepcionista]: ¿Puedo saber de qué lo conocía? Hay una buena diferencia de edad."),
                ...
                new Phrase("Anciano")
                    .withAlternative(roles => "[Anciano]: Quiso verle él mismo pero nunca llegó a encontrarle. Yo llevo años buscándolo sabiendo solo bagamente su nombre y lo que mi padre encontró."),
                new Phrase("Anciano")
                    .withAlternative(roles => "[Anciano]: Ya pensaba que mi hijo heredaría la tarea. Mire usted qué suerte. A Burgos pues iremos."),
                new Phrase("Recepcionista")
                    .withAlternative(roles => "[Recepcionista]: Que historia tan curiosa. Esconde la gente anciana a menudo historias fascinantes."),
                new Phrase("Anciano")
                    .withAlternative(roles => "[Anciano]: Desde luego."),
                new Phrase("Recepcionista")
                    .withAlternative(roles => "[Recepcionista]: Mucha suerte en Burgos señor Caspe. Por cierto, le dejo un tríptico de la residencia por si cambia de idea..."),
            ],
            Timing.GlobalSingle,
            (postconditions, roles, map) => 
                map.getUbication(roles.get("Anciano")).name === "Recepcion" 
